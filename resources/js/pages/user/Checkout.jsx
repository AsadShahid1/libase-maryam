...
export default function Checkout() {
  ...
  useEffect(() => {
    ...
    if (settings.payment_cod_enabled === '1') setForm(p => ({ ...p, payment: 'cod' }))
    else if (settings.payment_bank_enabled === '1') setForm(p => ({ ...p, payment: 'bank' }))
    else if (settings.payment_easypaisa_enabled === '1') setForm(p => ({ ...p, payment: 'easypaisa' }))
    else if (settings.payment_jazzcash_enabled === '1') setForm(p => ({ ...p, payment: 'jazzcash' }))
  }, [settings])
