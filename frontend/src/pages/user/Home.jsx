...
import { getShopProducts, getShopMetadata, submitContactMessage } from '@/api'
...
export default function Home() {
  ...
  const { settings, categories } = useOutletContext()
  ...
  // Load public metadata & unique colors dynamically
  useEffect(() => {
    getShopMetadata()
      .then(res => {
  ...
  // Trigger catalog fetch whenever filter values change
  useEffect(() => {
    loadCatalog()
  }, [selectedCategory, selectedBrand, selectedSize, selectedColor, minPrice, maxPrice, searchParams])
